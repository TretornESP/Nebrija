...
typedef struct acpi_hpet_header{
    struct acpi_sdt_header header;
    uint8_t revision_id;
...
typedef struct acpi_headers {
    uint8_t valid;
    acpi_mcfg_header_t* mcfg_header;
    acpi_madt_header_t* madt_header;
    acpi_hpet_header_t* hpet_header;
} acpi_headers_t;
